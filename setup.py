...
URL = "https://github.com/MenneBos/skill-ovos-light"
SKILL_CLAZZ = "LightSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-light"  # pip install PYPI_NAME
...
setup(
    name='ovos-skill-light',
    version=get_version(),
    description='A skill to switch on off light',
    url='https://github.com/MenneBos/skill-ovos-light',
    author='Menne',
